    ...
    <nav className="bg-white border-gray-200 dark:bg-blue-400">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-default"
        >
          <ul className="font-medium flex flex-col p-[10px] mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            {user ? (
              <>
                <li>
                  <Link
